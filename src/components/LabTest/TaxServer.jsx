...
const TaxServer = () => {
  return (
    ...
    <img  className='mt-5' src="https://images1-fabric.practo.com/dx/labs/PRL-TSA/logo.png/400x268" alt="" />
    </div>


    {/* second page */}
    <div class="col col-md-5 mt-5">
      <p className='bgGreen '>20%</p>

<p className='h2'>Tax Saver Package (Advanced) - Full body checkup with Cardiac risk markers & Vit B12</p>
<p className='fs-6'>Ideal for individuals aged 18-100 years
Includes 110 tests</p>
