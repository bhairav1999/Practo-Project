...
<div id="carouselExampleControls" className="carousel slide h-100 w-100 mb-5" data-bs-ride="carousel">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="./assets/img/Carousel_Img1.png" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="./assets/img/Carousel_Img2.jpg" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="./assets/img/Carousel_Img3.png" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="./assets/img/Carousel_Img4.png" className="d-block w-100" alt="..."/>
    </div>
  </div>
